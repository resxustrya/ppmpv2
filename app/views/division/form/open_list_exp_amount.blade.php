...
@section('content')
<div id="container6" data-save="{{ asset('save/division/open_list_exp') }}" data-get="{{ asset('get/division/open_list_exp/'.$ppcode) }}" data-ppcode="{{ $ppcode }}"></div>
@endsection
@section('js')
    <script>
        ...
        hot6 = new Handsontable(container6, {
            ...
            cells: function(r,c, prop) {
                var cellProperties = {};
                if (c ===  0 || c=== 1 || c === 11) cellProperties.readOnly = true;
