...
<div class="signup-box">
    ...
    <div class="card">
        <div class="body">
            <form id="{{ asset('edit/division') }}" method="POST">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="text" class="form-control" name="division" value="{{ $division->description }}" placeholder="Enter division name" required>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <select name="head" class="form-control" required>
                            ...
                            @foreach(DB::table('users')->get() as $user)
                                <option value="{{ $user->id }}" {{ $user->id == $division->head ? 'selected ' : '' }}>{{ $user->lname ." ". $user->fname }}
                            @endforeach
                        </select>
                    </div>
                </div>
