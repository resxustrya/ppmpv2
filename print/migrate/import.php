...
$server = 'localhost';
   ...
   // $query = "INSERT IGNORE INTO table_g(code,ppcode,item,unit,q1_qty,q1_amt,created_by,date_added) VALUES";
foreach($open_list as $list)
{
    ...
    //$query.= "('" . $list['code'] . "','" . $list['ppcode'] . "','" . addslashes($list['item']) ."','".$list['unit']."','" . $list['quantity'] . "','" . $list['amount'] . "','".$list['created_by']."','" .$list['date_added']. "'),";
