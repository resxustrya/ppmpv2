...
foreach($sections as $section):
    $st = $pdo->prepare("SELECT * FROM table_z WHERE created_by = ? AND (q1_qty > 0 OR q2_qty > 0 OR q3_qty > 0 OR q4_qty > 0) GROUP BY item ORDER BY item ASC");
...
$pdf->SetFont('Arial','B',8);
$pdf->Row(array("","OFFICE SUPPLIES TOTAL ","","",number_format($grand_total,2),"","",'','','','','','','',''));
