...
foreach($items as $item):
    ...
    //compute table A total;
    $table_a_total += $row_total;
...
$grand_total += $table_a_total;
$table_a_total = $table_a_total > 0 ? number_format($table_a_total,2) : 0;
$pdf->SetFont('Arial','B',9);
$pdf->Row(array("","\t\t\t\t\t\t\t\t\t\t\t\t","","Total",$table_a_total,"","",'','','','','','','',''));
